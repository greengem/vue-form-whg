<template>
  <div class="locale-changer relative">
    <select
      ...
      class="text-sm min-w-16 px-3 py-1 rounded-lg bg-white dark:bg-slate-800 dark:text-slate-100 shadow-md ring-1 ring-slate-300 dark:ring-slate-700 appearance-none"
    >
