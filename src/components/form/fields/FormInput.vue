...
const inputClass =
  'text-sm w-full px-3 py-2 rounded-lg bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-red-500 shadow-md ring-1 ring-slate-300 dark:ring-slate-600 appearance-none'
